...
public final class ModKeyBindings {
    ...
    public static void register() {
        fastBreakKey = register(KEY_FAST_BREAK, com.mojang.blaze3d.platform.InputConstants.KEY_B);
        fastPlaceKey = register(KEY_FAST_PLACE, com.mojang.blaze3d.platform.InputConstants.KEY_V);
        harvestKey = register(KEY_HARVEST, com.mojang.blaze3d.platform.InputConstants.KEY_H);
        boneMealKey = register(KEY_BONE_MEAL, com.mojang.blaze3d.platform.InputConstants.KEY_N);
        profileKey = register(KEY_PROFILE, com.mojang.blaze3d.platform.InputConstants.KEY_P);
        emergencyStopKey = register(KEY_EMERGENCY_STOP, com.mojang.blaze3d.platform.InputConstants.KEY_K);
    }
